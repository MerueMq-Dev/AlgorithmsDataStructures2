...
namespace AlgorithmsDataStructures2
{
    public class Program
    {
        ...
        {
            // Пример 1: Граф с несколькими циклами
            ...
            graph1.AddEdge(0, 1);
            graph1.AddEdge(1, 2);
            graph1.AddEdge(2, 0); // Цикл 0-1-2-0
            graph1.AddEdge(2, 3);
            graph1.AddEdge(3, 4);
            graph1.AddEdge(4, 2); // Цикл 2-3-4-2
            ...
            // Пример 2: Граф без циклов (Дерево)
            ...
            // // Пример 4: Граф с множеством рёбер, но без циклов
            ...
            // graph5.AddEdge(3, 4);
            // graph5.AddEdge(4, 5);
            // var cycles5 = graph5.FindAllCyclesBFS();
